...
from ..serializers.bike_way_mls_serializer import BikeWaysMLSCreationSerializer


class BikeWaysMLSCreationView(APIView):
    def post(self, request):
        try:
            data = JSONParser().parse(request)
            serializer = BikeWaysMLSCreationSerializer(data=data)
